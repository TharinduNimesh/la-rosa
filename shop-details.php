...
<head>
   ...
   <body>
         ...
         <div class="lv-header-sidebar-wrapper">
            ...
            <div class="lv-footer-touch-widget-box lv-header-sidebar-touch-widget text-center">
               ...
               <div class="lv-footer-touch-widget-links pb-20">
                  <a href="https://envato.bdevstech.com/cdn-cgi/l/email-protection#20494e464f4c4f56454c4545604558414d504c450e434f4d"><span class="__cf_email__" data-cfemail="ddb4b3bbb2b1b2abb8b1b8b89db8a5bcb0adb1b8f3beb2b0">[email&#160;protected]</span></a>
      ...
      <main>
         ...
         <div class="shop-details-area pb-80">
            <div class="container">
                  ...
                  <div class="col-xxl-5 col-xl-5 col-lg-6">
                     <div class="lv-shop-details-right-content-1-7 lv-shop-details-right-content-space-1-7">
                        ...
                        <div class="lv-shop-details-short-text-1-7 mb-45">
                           <p>Discover beauty watching videos of the weddings we planned in these years. Each month you will find a new one shot in one of the most beautiful spot of Lovelee.</p>
                        </div>
               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="lv-shop-details-product-content-tab-wrapper-1-7">
                        <div class="lv-shop-details-product-tab-buttons-1-7">
                           <nav>
                             <div class="nav" id="nav-tab2" role="tablist">
                               <button class="active" id="nav-description-tab" data-bs-toggle="tab" data-bs-target="#nav-description" type="button" role="tab" aria-controls="nav-description" aria-selected="true">Description</button>
                               <button id="nav-additional-info-tab" data-bs-toggle="tab" data-bs-target="#nav-additional-info" type="button" role="tab" aria-controls="nav-additional-info" aria-selected="false">Additional info</button>
                               <button id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" aria-controls="nav-review" aria-selected="false">Reviews (01)</button>
                             </div>
                           </nav>
                        </div>
                        <div class="lv-shop-details-product-tab-content-1-7">
                           <div class="tab-content" id="nav-tabContent">
                             <div class="tab-pane fade show active" id="nav-description" role="tabpanel" aria-labelledby="nav-description-tab">
                                 <p class="lv-shop-description-text">As the matter of fact, we have been looking for “the” perfect venue for years. After a long research we discover that “perfect perfection” does not exist! Our brides and groom decide what is perfect for them. We just need to help them choosing!Each couple loves to make it different, they like different venues, decors, destinations.For this reason we decided to show you a selection of the venues we love. We feel that you are going to fall in love with these special venues as we did.</p>
                             </div>
                             ...
                             <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                                <div class="product__details-review mb-35">
                                    <div class="row">
                                                             ...
                                                             <div class="comments-text">
                                                                 ...
                                                                 <div class="user-rating">
                                                                     <ul>
                                                                         ...
                                                                         <li><a href="#0"><i class="fas fa-star"></i></a></li>
                                                                         <li><a href="#0"><i class="fas fa-star"></i></a></li>
                                                                         <li><a href="#0"><i class="fal fa-star"></i></a></li>
                                                                     </ul>
                                                                 </div>
                                       ...
                                       <div class="col-xxl-6">
                                          <div class="post-comments-form pl-20">
                        ...
                        <div class="footer-widget pl-20 pr-20">
                           <div class="lv-footer-touch-widget-box text-center">
                              ...
                              <div class="lv-footer-touch-widget-links">
                                 <a href="https://envato.bdevstech.com/cdn-cgi/l/email-protection#e1888f878e8d8e97848d8484a18499808c918d84cf828e8c"><span class="__cf_email__" data-cfemail="422b2c242d2e2d34272e272702273a232f322e276c212d2f">[email&#160;protected]</span></a>
                                 <a href="tel:+88587985598">(+88) 587 - 985 -598</a>
                                 <span>Magla Street, New York, USA</span>
                              </div>
                           </div>
