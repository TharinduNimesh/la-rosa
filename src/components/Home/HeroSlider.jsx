    ...
    <div class="slider-area p-rel" id="slider">
            ...
            >
              <div class="container">
                <div class="lv-single-slider-content text-center pt-125">
                  <h2 class="lv-single-slider-title" data-animation="fadeInUp">
                    Born to Shine
                  </h2>
                  <p
                    ...
                    data-delay=".2s"
                  >
                    If you are dreaming about getting married ... you are in the
                    right place!
                  </p>
                  <div
      ...
      <div class="lv-slider-pagination">
        <div class="swiper-button-prev">
          <img src="assets/img/path/navigation-prev.png" alt="" />
        </div>
        <div class="slider-paginations"></div>
        <div class="swiper-button-next">
          <img src="assets/img/path/navigation-next.png" alt="" />
        </div>
      </div>
