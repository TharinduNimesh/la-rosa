...
<!-- Mirrored from envato.bdevstech.com/html/lovelee-prv/lovelee/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Mar 2025 18:21:36 GMT -->
<head>
      <meta charset="utf-8">
         ...
         <div class="lv-header-sidebar-wrapper">
            ...
            <div class="lv-footer-touch-widget-box lv-header-sidebar-touch-widget text-center">
               ...
               <div class="lv-footer-touch-widget-links pb-20">
                  <a href="https://envato.bdevstech.com/cdn-cgi/l/email-protection#6c05020a0300031a090009092c09140d011c0009420f0301"><span class="__cf_email__" data-cfemail="9cf5f2faf3f0f3eaf9f0f9f9dcf9e4fdf1ecf0f9b2fff3f1">[email&#160;protected]</span></a>
               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="lv-breadcrumb-content">
                        <h4 class="lv-breadcrumb-title text-center">Team</h4>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="lv-photography-member-social-share lv-photography-member-social-share-1-3 mb-20">
                        <div class="fix">
                           <div class="lv-photography-img-1-2 bg-default lv-photography-img" data-background="assets/img/team/team-5.jpg"></div>
                        </div>
                        <div class="lv-photography-member-content text-center">
                           <a href="team-details.html" class="lv-photography-member-designation-link">Photographer</a>
                           <h5 class="lv-photography-member-name"><a href="team-details.html">Queen Sara Jaclin </a></h5>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="lv-photography-member-social-share lv-photography-member-social-share-1-3 mb-20">
                        <div class="fix">
                           <div class="lv-photography-img-1-2 bg-default lv-photography-img" data-background="assets/img/team/team-7.jpg"></div>
                        </div>
                        <div class="lv-photography-member-content text-center">
                           <a href="team-details.html" class="lv-photography-member-designation-link">Designer</a>
                           <h5 class="lv-photography-member-name"><a href="team-details.html">Evelyn Romano</a></h5>
                           <div class="lv-photography-member-social-links">
                              <a href="#">FB</a>
                              <a href="#">TW</a>
                              <a href="#">IN</a>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="lv-photography-member-social-share lv-photography-member-social-share-1-3 mb-20">
                        <div class="fix">
                           <div class="lv-photography-img-1-2 bg-default lv-photography-img" data-background="assets/img/team/team-3.jpg"></div>
                        </div>
                        <div class="lv-photography-member-content text-center">
                           <a href="team-details.html" class="lv-photography-member-designation-link">Developer</a>
                           <h5 class="lv-photography-member-name"><a href="team-details.html">Dorothy Ryania</a></h5>
                           <div class="lv-photography-member-social-links">
                              <a href="#">FB</a>
                              <a href="#">TW</a>
                              <a href="#">IN</a>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="lv-photography-member-social-share lv-photography-member-social-share-1-3 mb-20">
                        <div class="fix">
                           <div class="lv-photography-img-1-2 bg-default lv-photography-img" data-background="assets/img/team/team-4.jpg"></div>
                        </div>
                        <div class="lv-photography-member-content text-center">
                           <a href="team-details.html" class="lv-photography-member-designation-link">Designer</a>
                           <h5 class="lv-photography-member-name"><a href="team-details.html">Queen Sara Jaclin </a></h5>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="lv-photography-member-social-share lv-photography-member-social-share-1-3 mb-20">
                        <div class="fix">
                           <div class="lv-photography-img-1-2 bg-default lv-photography-img" data-background="assets/img/team/team-1.jpg"></div>
                        </div>
                        <div class="lv-photography-member-content text-center">
                           <a href="team-details.html" class="lv-photography-member-designation-link">Architect</a>
                           <h5 class="lv-photography-member-name"><a href="team-details.html">Selena Mariasha</a></h5>
                           <div class="lv-photography-member-social-links">
                              <a href="#">FB</a>
                              <a href="#">TW</a>
                              <a href="#">IN</a>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="lv-photography-member-social-share lv-photography-member-social-share-1-3 mb-20">
                        <div class="fix">
                           <div class="lv-photography-img-1-2 bg-default lv-photography-img" data-background="assets/img/team/team-6.jpg"></div>
                        </div>
                        <div class="lv-photography-member-content text-center">
                           <a href="team-details.html" class="lv-photography-member-designation-link">Photographer</a>
                           <h5 class="lv-photography-member-name"><a href="team-details.html">Daniyel Dckock</a></h5>
                           <div class="lv-photography-member-social-links">
                              <a href="#">FB</a>
                              <a href="#">TW</a>
                              <a href="#">IN</a>
                     ...
                     <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 mb-30 mb-lg-0">
                        <div class="footer-widget">
                           <div class="lv-footer-link-logo-wrap">
                              <a href="about.html" class="lv-footer-link-menu">STAB</a>
                              <div class="lv-footer-link-logo">
                                 <a href="index.html"><img src="assets/img/logo/logo-black.png" alt="logo not found"></a>
                              </div>
                              <a href="contact.html" class="lv-footer-link-menu">2022</a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="footer-widget pl-20 pr-20">
                           <div class="lv-footer-touch-widget-box text-center">
                              ...
                              <div class="lv-footer-touch-widget-links">
                                 <a href="https://envato.bdevstech.com/cdn-cgi/l/email-protection#84edeae2ebe8ebf2e1e8e1e1c4e1fce5e9f4e8e1aae7ebe9"><span class="__cf_email__" data-cfemail="e980878f8685869f8c858c8ca98c91888499858cc78a8684">[email&#160;protected]</span></a>
                                 <a href="tel:+88587985598">(+88) 587 - 985 -598</a>
                                 <span>Magla Street, New York, USA</span>
                              </div>
                           </div>
...
<!-- Mirrored from envato.bdevstech.com/html/lovelee-prv/lovelee/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Mar 2025 18:21:37 GMT -->
</html>
