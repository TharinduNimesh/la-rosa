            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="lv-breadcrumb-content">
                        <h4 class="lv-breadcrumb-title text-center">404 Not Found</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 text-center">
                    <div class="error-content">
                        ...
                        <p class="error-text mb-35">The page you are looking for might have been removed, had its name
                            changed, or
                            is temporarily unavailable.</p>
                        <div class="lv-about-action">
                            <a href="/" class="lv-theme-btn">
