...
<head>
    ...
    <meta name="description"
        content="<?php echo isset($page_description) ? $page_description : 'LaRosa offers premium wedding and event planning services. Transform your special day into an unforgettable experience with our expert team.'; ?>">
    <meta name="keywords"
        content="<?php echo isset($page_keywords) ? $page_keywords : 'wedding planning, event planning, luxury events, wedding services, LaRosa events'; ?>">

    <!-- Open Graph / Social Media -->
    <meta property="og:title"
        content="<?php echo isset($page_title) ? $page_title . ' | LaRosa' : 'LaRosa - Wedding & Event Planning'; ?>">
    <meta property="og:description"
        content="<?php echo isset($page_description) ? $page_description : 'LaRosa offers premium wedding and event planning services. Transform your special day into an unforgettable experience with our expert team.'; ?>">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo isset($current_url) ? $current_url : 'https://larosaflora.com'; ?>">
    <meta property="og:image"
        content="<?php echo isset($og_image) ? $og_image : 'public/assets/img/og-default.jpg'; ?>">
