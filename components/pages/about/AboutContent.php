            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="lv-about-content-right lv-about-content-right-1-1">
                    <div class="lv-about-content-wrap">
                        <h3 class="lv-section-title lv-section-title-1-1 mb-10">We inspire you to bring wedding to real
                            life</h3>
                        <p class="lv-about-content mb-35">We know this is one of the most important days of your life,
                            and you need to hire a wedding planner whom you can trust respect. Most importantly, you
                            need to hire a company that allows you to enjoy every minute of your wedding planning
                            company be that company for you!</p>
                    </div>
                    <div class="lv-about-blue-point-wrap mb-40">
                        <div class="row">
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                <div class="lv-about-blue-point-left">
                                    <h4 class="lv-about-blue-point-title"><span>18+</span> Years<br> Real Experiences
                                    </h4>
                                </div>
                            </div>
