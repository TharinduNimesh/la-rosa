    ...
    <?php if ($imgCount > 0): ?>
      <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 grid-items">
        <a class="image-popups" href="<?php echo $galleryUrl . basename($images[0]); ?>">
          <div class="lv-p-details-grid-item-1-4-1 mb-15 bg-default"
            data-bg="<?php echo $galleryUrl . basename($images[0]); ?>"></div>
        </a>
      </div>
    <?php endif; ?>
    <?php if ($imgCount > 1): ?>
      <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 grid-items">
        <a class="image-popups" href="<?php echo $galleryUrl . basename($images[1]); ?>">
          <div class="lv-p-details-grid-item-1-4-2 mb-15 bg-default"
            data-bg="<?php echo $galleryUrl . basename($images[1]); ?>"></div>
        </a>
      </div>
    <?php endif; ?>
          ...
          <?php if ($imgCount > 2): ?>
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
              <a class="image-popups" href="<?php echo $galleryUrl . basename($images[2]); ?>">
                <div class="lv-p-details-grid-item-1-4-3 mb-15 bg-default"
                  data-bg="<?php echo $galleryUrl . basename($images[2]); ?>"></div>
              </a>
            </div>
          <?php endif; ?>
          <?php if ($imgCount > 3): ?>
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12">
              <a class="image-popups" href="<?php echo $galleryUrl . basename($images[3]); ?>">
                <div class="lv-p-details-grid-item-1-4-3 mb-15 bg-default"
                  data-bg="<?php echo $galleryUrl . basename($images[3]); ?>"></div>
              </a>
            </div>
          <?php endif; ?>
        </div>
    ...
    <?php if ($imgCount > 4): ?>
      <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 grid-items">
        <a class="image-popups" href="<?php echo $galleryUrl . basename($images[4]); ?>">
          <div class="lv-p-details-grid-item-1-4-4 mb-15 bg-default"
            data-bg="<?php echo $galleryUrl . basename($images[4]); ?>"></div>
        </a>
      </div>
    <?php endif; ?>
    <?php if ($imgCount > 5): ?>
      <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 grid-items">
        <a class="image-popups" href="<?php echo $galleryUrl . basename($images[5]); ?>">
          <div class="lv-p-details-grid-item-1-4-3 mb-15 bg-default"
            data-bg="<?php echo $galleryUrl . basename($images[5]); ?>"></div>
        </a>
      </div>
    <?php endif; ?>
    <?php if ($imgCount > 6): ?>
      <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 grid-items">
        <a class="image-popups" href="<?php echo $galleryUrl . basename($images[6]); ?>">
          <div class="lv-p-details-grid-item-1-4-3 mb-15 bg-default"
            data-bg="<?php echo $galleryUrl . basename($images[6]); ?>"></div>
        </a>
      </div>
    <?php endif; ?>
    <?php if ($imgCount > 7): ?>
      <?php for ($i = 7; $i < $imgCount; $i++): ?>
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 grid-items">
          <a class="image-popups" href="<?php echo $galleryUrl . basename($images[$i]); ?>">
            <div class="lv-p-details-grid-item-1-4-3 mb-15 bg-default"
              data-bg="<?php echo $galleryUrl . basename($images[$i]); ?>"></div>
          </a>
        </div>
      <?php endfor; ?>
    <?php endif; ?>
  ...
  <div class="row">
    <div class="col-xxl-12">
      <div class="text-center mt-3">
        <a href="?category=<?php echo urlencode($category); ?>&imgpage=<?php echo $page + 1; ?>"
          class="lv-banner-link-3">Load More</a>
      </div>
    </div>
  </div>
<?php endif; ?>
